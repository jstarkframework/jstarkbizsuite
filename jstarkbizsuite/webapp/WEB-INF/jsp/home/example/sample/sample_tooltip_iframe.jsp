...
<div class="jskui_header">
    <div class="jskui_header_title">Tooltip iframe</div>
...
<div class="jskui_main">
	...
	<div class="jskui_group">
	    <div id="jskid_scroll_td_div" class="jskui_scroll_td_div">
		    ...
		    <tr>
			    <td>
                    <div class="jskui_tooltip"><div><span onmouseover="jskfn_tooltip_iframe_show(this, 500, 'jskid_main_frame');" onmouseout="jskfn_tooltip_iframe_hide();">abcdefghijklmnopqrstuvwxyz<br />abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyz<br />abcdefghijklmnopqrstuvwxyz</span></div></div>
			    </td>
			    <td>
				    <div class="jskui_tooltip"><div><span onmouseover="jskfn_tooltip_iframe_show(this, 200, 'jskid_main_frame');" onmouseout="jskfn_tooltip_iframe_hide();">1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890</span></div></div>
			    </td>
			    <td>
			        <div class="jskui_tooltip"><div><span onmouseover="jskfn_tooltip_iframe_show(this, 500, 'jskid_main_frame');" onmouseout="jskfn_tooltip_iframe_hide();">abcdefghijklmnopqrstuvwxyz<br />abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyz<br />abcdefghijklmnopqrstuvwxyz</span></div></div>
			    </td>
