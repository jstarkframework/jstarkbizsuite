...
<div class="jskui_header">
    <div class="jskui_header_title">List Iframe Scroll Resize</div>
...
<div class="jskui_main">
    ...
    <div class="jskui_group">
        <iframe name="jskid_content_frame" id="jskid_content_frame" scrolling="no" src="<%=jcontext%>/example/ui/ui_list_iframe_data_resize.do" frameborder="0" width="100%" height="100%" style="padding:0px;margin:0px;"></iframe>
    </div>
</div>
