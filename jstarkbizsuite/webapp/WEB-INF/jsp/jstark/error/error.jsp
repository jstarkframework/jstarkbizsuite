...
%><%@ page import = "jstark.framework.*,org.jstark.framework.core.*,jstark.platform.*" %><%
...
if(exception!=null)
{
    ...
    if(err_msg!=null && ("jstark_request_block".equals(err_msg)))
    {
        ErrorUtils.err(exception);
%><jsp:include page="/WEB-INF/jsp/jstark/error/error_blocked.jsp" flush="false" /><%
    }
    else
    {
        ErrorUtils.err(exception, false);
