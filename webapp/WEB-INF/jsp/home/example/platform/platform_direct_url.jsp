...
<div class="jskui_header">
    <div class="jskui_header_title">Direct URL</div>
    <div class="jskui_header_sub"></div>
</div>
<div class="jskui_main">
    <div class="jskui_button_bar">
        <button type="button" onclick="fn_button(); return false;">Go</button>
    </div>
    ...
    <tr>
        <td class="jskui_left">/platform/main.do?g_no=G20070220AAAAAAAAAAADUA&g_url=/platform/menu/index.do</td>
    </tr>
    </table>
...
<script type="text/javascript">
    ...
    function fn_button()
    {
        top.location.href = "/platform/main.do?g_no=G20070220AAAAAAAAAAADUA&g_url=/platform/menu/index.do";
    };
