...
<link rel="stylesheet" type="text/css" href="${jcontext}/web/jstark/platform/css/jstark.navigator.min.css?<%=CoreUtils.getRevision()%>" />
...
<script type="text/javascript" src="${jcontext}/web/jstark/platform/js/jstark.navigator.min.js?<%=CoreUtils.getRevision()%>"></script>
