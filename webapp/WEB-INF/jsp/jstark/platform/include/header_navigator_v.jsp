...
<title>TERALAKER</title>
<link rel="stylesheet" type="text/css" href="${jcontext}/web/jstark/platform/css/jstark.min.css?<%=CoreUtils.getRevision()%>" />
<link rel="stylesheet" type="text/css" href="${jcontext}/web/jstark/platform/css/jstark.navigator.v.min.css?<%=CoreUtils.getRevision()%>" />
...
<script type="text/javascript" src="${jcontext}/web/jstark/platform/js/jstark.navigator.v.min.js?<%=CoreUtils.getRevision()%>"></script>
